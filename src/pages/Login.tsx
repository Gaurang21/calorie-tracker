    ...
    <div className="min-h-screen flex items-center justify-center p-4 warm-bg">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="h-14 w-14 rounded-3xl grid place-items-center text-white mb-5"
        ...
        <div className="card p-7" style={{ borderRadius: '32px' }}>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button disabled={busy} className="btn-primary w-full">{busy ? 'Signing you in…' : 'Sign in 🌿'}</button>
          </form>
