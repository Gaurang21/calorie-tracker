// Groq backend — same exported function signatures as ollamaService.js.
...
async function callGroq(prompt, systemPrompt = '', expectJson = false, opts = {}) {
...
Respond with this exact JSON structure:
{
  ...
  return callGroq(prompt, system, true);
}
