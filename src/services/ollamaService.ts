...
// Photo analysis remains in geminiService.ts.
...
async function callOllama(prompt: string, systemPrompt: string, expectJson: false): Promise<string>;
async function callOllama(prompt: string, systemPrompt: string, expectJson: true): Promise<unknown>;
async function callOllama(prompt: string, systemPrompt: string = '', expectJson: boolean = false): Promise<string | unknown> {
...
Respond with this exact JSON structure:
{
  ...
  return callOllama(prompt, system, true) as Promise<ParseFoodResult>;
}
...
Return JSON:
{
  ...
  return callOllama(prompt, system, true) as Promise<MealSuggestionResult>;
}
...
Return JSON:
{
  ...
  return callOllama(prompt, system, true) as Promise<FoodSwapResult>;
}
